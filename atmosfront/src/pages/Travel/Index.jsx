...
import Formulario from '../../components/Cptravel/Formulario'
import Tabela from '../../components/Cptravel/Tabela'
    ...
    <>
      <div>
        ...
        <div className="container px-4 py-4" id="icon-grid">
          <h2 className="pb-5 border-bottom text-center"><strong>Destinos</strong></h2>
        </div>
